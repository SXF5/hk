                            ...
                            <table class="layui-table layui-form" lay-filter="mylist" lay-size="lg">
                              ...
                              <c:forEach items="${teachers}" var="item">
                                <tr>
                                  ...
                                  <td>评价列表，查看列表</td>
                                  <td><c:if test="${item.power==1 }">被评审者，进行同行评审</c:if>
                                  	  <c:if test="${item.power==2 }">评审者，除管理员最高权限者</c:if>
                                  ...
                                  <td class="td-manage">
							       <button class="layui-btn layui-btn layui-btn-xs"
												onclick="xadmin.open('编辑用户','${pageContext.request.contextPath}/manager/roleupdate?teacherid=${item.teacherid}',600,400 )"
												href="javascript:;">
